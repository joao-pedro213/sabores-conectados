package com.postech.saboresconectados.infrastructure.user.data.repository;
...
@Sql(value = {"/infrastructure/user/repository/user-test-sample.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_CLASS)
